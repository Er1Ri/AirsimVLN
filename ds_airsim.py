...
erniebot.access_token = "85e4da****************" #改成自己的
MY_MODEL = "ernie-4.0" #ernie-bot",ernie-bot-turbo,ernie-bot-4,ernie-bot-8k,ernie-text-embedding,ernie-vilg-v2


class ErnieAirSim:
    def __init__(self, system_prompts="system_prompts/airsim_basic_cn.txt", prompt="prompts/airsim_basic_cn.txt", example_msg=[]):
        """
        类从初始化
        :param system_prompts: 系统prompt文件
        :param prompt: 知识库prompt文件
        :param example_msg: 样例对话，message数组
        """
        # 系统提示
...
if __name__=="__main__":
    ...
    ernie_airsim = ErnieAirSim(example_msg=example_msg)
    command = "起飞"
